...
HIL prepare SPI Flash data and DUT read test 512 bytes
    # --- HIL setup ---
    HIL prepare SPI Flash data    ${LENGTH_512}
    # --- DUT read data ---
    ${data}    Read SPI Flash Data    ${LENGTH_512}
...
DUT erase SPI Flash and read test
    ...
    # --- DUT read data ---
    ${data}    Read SPI Flash Data    ${LENGTH_1K}
    Is SPI Flash Data Erased    ${data}

DUT write SPI Flash and read test 1024 bytes
    # --- DUT write data ---
    Write SPI Flash Data    ${LENGTH_1K}
    # --- DUT read data ---
    ${data}    Read SPI Flash Data    ${LENGTH_1K}
    Data Should Increment    ${data}
