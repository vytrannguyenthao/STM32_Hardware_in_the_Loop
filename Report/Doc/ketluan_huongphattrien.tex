...
\begin{itemize}
    ...
    \item Tần số lấy mẫu của HIL Collector vẫn còn giới hạn, ảnh hưởng đến khả năng thu thập và phân tích các tín hiệu có tốc độ cao.
\end{itemize}
...
\begin{itemize}
    ...
    \item Tích hợp mạng cho hệ thống. Từ đó hệ thống sẽ hoạt động độc lập mà không cần phải kết nối trực tiếp với máy tính thông qua USB. Các dữ liệu thu thập sẽ được gửi về máy chủ để lưu trữ, giám sát và xử lý từ xa.
