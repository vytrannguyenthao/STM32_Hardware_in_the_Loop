...
\section{Các giao thức giao tiếp ngoại vi trong khối HIL Generator}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{image/i2c.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{image/spi.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{image/can_frame.jpg}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.55\textwidth]{image/thread_state.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{image/couting_sem.jpg}
...
Ví dụ:
\begin{itemize}
    \item \texttt{thread\_1} giữ semaphore A và đợi semaphore B.
    \item \texttt{thread\_2} giữ semaphore B và đợi semaphore A.
\end{itemize}
